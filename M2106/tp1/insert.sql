...
insert into ADHERENT values(1,'aflau','jean','president','grenoble','0476441250','oui',2017);
insert into ADHERENT values(2,'maire','pierre','vice-president','grenoble','0476501265','oui',2017);
insert into ADHERENT values(3,'boucher','anne','vice-president','meylan','0476152360','non',2017);
insert into ADHERENT values(4,'michal','veronique','secretaire','grenoble','0476451252','non',2018);
insert into ADHERENT values(5,'guy','fabien','tresorier','meylan','0476441250','oui',2018);
insert into ADHERENT values(6,'rousseau','julien','membre actif','veurey','0476531256','non',2018);
insert into ADHERENT values(7,'frantz','paul','membre actif','st-égrève','0476531278','non',2018);
insert into ADHERENT values(8,'colin','serge','membre actif','st-ismier','0476531237','non',2018);
insert into ADHERENT values(9,'boulle','yves','membre actif','meylan','0476531586','non',2018);
insert into ADHERENT values(10,'rondet','audrey','membre actif','grenoble','0476527130','oui',2019);
insert into ADHERENT values(11,'garnier','christophe','autre','échirolles','0476852130','non',2019);
insert into ADHERENT values(12,'bar','thierry','autre','st-égrève','0476535678','non',2019);
insert into ADHERENT values(13,'merlu','christian','autre','veurey','0476371852','oui',2019);
insert into ADHERENT values(14,'crevette','sylvie','autre','st-ismier','0476458293','non',2019);
insert into ADHERENT values(15,'morue','dominique','autre','grenoble','0476349725','non',2019);
insert into ADHERENT values(16,'saumon','claude','autre','grenoble','0476482497','non',2019);
insert into ADHERENT values(17,'limande','thierry','autre','voiron','0476165874','non',2019);
insert into ADHERENT values(18,'turbot','pascale','autre','vif','0476462597','non',2019);
insert into ADHERENT values(19,'crabe','sylvie','membre actif','st-ismier','0476452843','non',2019);
...
insert into ACTIVITE values(1,'sortie','Hyeres','Hyeres','8/06/2019','10/06/2019');
insert into ACTIVITE values(2,'rallye','Hyeres','Hyeres','6/07/2019','8/07/2019');
insert into ACTIVITE values(3,'sortie','Hyeres','Hyeres','8/08/2019','10/08/2019');
insert into ACTIVITE values(4,'sortie','Hyeres','Hyeres','9/08/2019','13/08/2019');
insert into ACTIVITE values(5,'rallye','Hyeres','Hyeres','16/08/2019','16/08/2019');
insert into ACTIVITE values(6,'sortie','Toulon','Toulon','02/09/2020','12/09/2020');
insert into ACTIVITE values(7,'sortie','Toulon','Toulon','14/09/2020','14/09/2020');
insert into ACTIVITE values(8,'rallye','Toulon','Toulon','15/06/2020','15/06/2020');
insert into ACTIVITE values(9,'sortie','Brest','Concarneau','14/09/2020','14/09/2020');
insert into ACTIVITE values(10,'sortie','Macinaggio','Centuri','14/09/2020','14/09/2020');
insert into ACTIVITE values(11,'sortie','Bastia','Ajaccio','10/08/2020','15/08/2020');
insert into ACTIVITE values(12,'rallye','Nice','Cannes','1/08/2020','1/08/2020');
insert into ACTIVITE values(13,'rallye','Monaco','Monaco','1/07/2020','1/07/2020');
...
insert into COTISATION values(1,2020, 125, 'oui');
insert into COTISATION values(2,2017, 100, 'oui');
insert into COTISATION values(2,2018, 110, 'oui');
insert into COTISATION values(2,2019, 120, 'oui');
insert into COTISATION values(2,2020, 125, 'non');
insert into COTISATION values(3,2017, 100, 'oui');
insert into COTISATION values(3,2018, 120, 'oui');
insert into COTISATION values(3,2019, 120, 'oui');
insert into COTISATION values(3,2020, 125, 'non');
insert into COTISATION values(4,2018, 110, 'oui');
insert into COTISATION values(4,2019, 120, 'oui');
insert into COTISATION values(4,2020, 125, 'oui');
insert into COTISATION values(5,2018, 110, 'oui');
insert into COTISATION values(5,2019, 120, 'oui');
insert into COTISATION values(5,2020, 125, 'oui');
insert into COTISATION values(6,2018, 110, 'oui');
insert into COTISATION values(6,2019, 110, 'oui');
insert into COTISATION values(6,2020, 115, 'oui');
insert into COTISATION values(7,2018, 110, 'oui');
insert into COTISATION values(7,2019, 110, 'oui');
insert into COTISATION values(7,2020, 115, 'oui');
insert into COTISATION values(8,2018, 120, 'oui');
insert into COTISATION values(8,2019, 120, 'oui');
insert into COTISATION values(8,2020, 120, 'non');
insert into COTISATION values(9,2018, 110, 'oui');
insert into COTISATION values(9,2019, 120, 'oui');
insert into COTISATION values(9,2020, 125, 'non');
insert into COTISATION values(10,2019, 120, 'oui');
insert into COTISATION values(10,2020, 125, 'oui');
insert into COTISATION values(11,2019, 120, 'oui');
insert into COTISATION values(11,2020, 125, 'oui');
insert into COTISATION values(12,2019, 120, 'oui');
insert into COTISATION values(12,2020, 125, 'oui');
insert into COTISATION values(13,2019, 120, 'oui');
insert into COTISATION values(13,2020, 125, 'oui');
insert into COTISATION values(14,2019, 120, 'oui');
insert into COTISATION values(14,2020, 125, 'oui');
insert into COTISATION values(15,2019, 130, 'oui');
insert into COTISATION values(15,2020, 135, 'non');
insert into COTISATION values(16,2019, 130, 'oui');
insert into COTISATION values(16,2020, 135, 'oui');
insert into COTISATION values(17,2019, 130, 'oui');
insert into COTISATION values(17,2020, 135, 'oui');
insert into COTISATION values(18,2019, 130, 'oui');
insert into COTISATION values(18,2020, 135, 'non');
insert into COTISATION values(19,2019, 130, 'oui');
insert into COTISATION values(19,2020, 130, 'non');

-- insertion dans AGENCE (nomagence,telephone,fax,adresse)
insert into  AGENCE values('plaisance','0494952018',null,'Marseille');
